...
public class More_OrderFood_page extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_more_orderfood_page); //set to show activity order food page
        ...
        OrderFood_Adapter_Card_vertical orderFood_adapter_Rcard = new OrderFood_Adapter_Card_vertical(sss,More_OrderFood_page.this);
